<?php
// SE PUEDE OPTIMIZAR TOMANDO EL PEDIDO COMO ELIMINACION
	...
	class Pedido{
		...
		public function Listar($idsucursal){
			...
			and c.tipo_persona = 'Cliente' & 'Distribuidor' & 'Vip' & 'Tipo 1' & 'Tipo 2' & 'N' and p.tipo_pedido = 'Venta' order by idpedido desc limit 0,10000";
	...
	where dp.idpedido = $idpedido";
		...
		public function ListarDetalleIngresos($idsucursal){
			...
			where i.estado = 'A' and i.idsucursal = $idsucursal and di.stock_actual > 0 order by stock_actual asc ";
			$query = $conexion->query($sql);
			return $query;
		}
