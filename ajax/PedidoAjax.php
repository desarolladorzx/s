            ...
            $i = 1;
     		while ($reg = $query_Tipo->fetch_object()) {
     			...
     			$data[] = array(
                    ...
                    '<button class="btn btn-success" data-toggle="tooltip" title="Generar Venta" onclick="pasarIdPedido('.$reg->idpedido.',\''.$fetch->total.'\',\''.$reg->idcliente.'\',\''.$reg->telefono.'\',\''.$reg->email.'\',\''.$reg->direccion_calle.'\',\''.$reg->direccion_calle.'\',\''.$reg->metodo_pago.'\',\''.$reg->agencia_envio.'\',\''.$reg->tipo_promocion.'\',\''.$reg->APCliente.'\')"><i class="fa fa-shopping-cart"></i> </button>&nbsp'.
